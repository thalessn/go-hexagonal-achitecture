...
import (
	...
	"github.com/thalessn/go-hexagonal/application"
)
...
func Run(service application.ProductServiceInterface, action string, productId string, productName string, price float64) (string, error) {
	...
	case "enable":
		...
		result = fmt.Sprintf("Prdocut %s has been enable.", res.GetName())
	...
	case "disable":
		...
		result = fmt.Sprintf("Prdocut %s has been disabled.", res.GetName())
	default:
